...
async function parseHTMLFile(filePath) {
    ...
    else if(imagesWithoutAlt.length)
    {
...
async function runDetection() 
{
    ...
    await checkAudioElements(filePath);
    await checkAccessibilityWithTabindex(filePath);
    await checkOneCharacterkey(filePath);
    await checkSkipLink(filePath);
    await checkOnInput(filePath);
    await checkLabel(filePath);
